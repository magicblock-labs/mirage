        ...
        get: {
            parameters: {
                query: {
                    ...
                    swapMode?: components["schemas"]["SwapMode"] & unknown;
                    ...
                    instructionVersion?: components["schemas"]["InstructionVersion"] & unknown;
...
export interface components {
    schemas: {
        ...
        SwapQuoteResponse: {
            ...
            swapMode: components["schemas"]["SwapMode"];
            slippageBps: number;
            ...
            instructionVersion?: components["schemas"]["InstructionVersion"];
            platformFee?: ({
                amount: string;
                feeBps: number;
            } & {
            ...
            contextSlot?: number;
            timeTaken?: number;
            additionalIntermediateTokens?: string[] | null;
        } & {
            [key: string]: unknown;
        };
        /** @enum {string} */
        ...
        SwapRequest: {
            ...
            quoteResponse: components["schemas"]["SwapQuoteResponse"];
            /**
            ...
            prioritizationFeeLamports?: number | ({
                ...
                jitoTipLamportsWithPayer?: number;
            } & {
                [key: string]: unknown;
            });
            /**
